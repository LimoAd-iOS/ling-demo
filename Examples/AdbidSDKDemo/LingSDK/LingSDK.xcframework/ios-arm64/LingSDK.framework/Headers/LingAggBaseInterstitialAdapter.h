//
//  LingAggBaseInterstitialAdapter.h
//  LingAggSDK
//
...
#import <LingSDK/LingAggInterstitialAdapterProtocol.h>
NS_ASSUME_NONNULL_BEGIN

@interface LingAggBaseInterstitialAdapter : NSObject<LingAggInterstitialAdapterProtocol>
